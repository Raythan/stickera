...
A nostalgic **sticker album** experience as a PWA: collect figurinhas from themed albums, open timed packs, complete sets, and trade duplicates with other players — **free**, **offline-capable**, installable via browser "Add to Home Screen", with content you publish from your repo/hosting.

Secondary goal: **portfolio MVP** showcasing web architecture, atomic UI, i18n, and static content pipelines — with clear **professional signature** (name, links, optional logo).
...
- Native app store builds (iOS / Android)
...
1. PWA installable via "Add to Home Screen" on mobile browsers.
2. First launch: fetches content from GitHub Pages and is playable.
...
5. Pulling newer manifest from hosting updates album list without any app store release.
